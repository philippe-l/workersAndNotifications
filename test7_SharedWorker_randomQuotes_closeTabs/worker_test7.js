...
onconnect = function(e) {
    ...
    windowsTab[0].onmessageerror = function (e) {
        console.log('windowsTab[0] onmessageerror');
        console.log(e);
        // on supprime l'élément en erreur.
        //windowsTab.shift();
    };

    windowsTab[0].onerror = function (e) {
        console.log('windowsTab[0] onError');
        console.log(e);
        // on supprime l'élément en erreur.
        //windowsTab.shift();
    };
